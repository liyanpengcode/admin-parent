package com.huifupay.system.common.log;
...
import com.huifupay.system.common.utils.IPUtils;
import com.huifupay.system.common.utils.StringUtil;
import com.huifupay.system.service.SysLogService;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.huifupay.system.controller..*.*(..))")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        if(!StringUtil.isEmpty(value)){
            ...
            com.huifupay.system.entity.SysLog sysLog=new com.huifupay.system.entity.SysLog();
